...
#         print(f"Average trip distance (yellow Jan 2024): {avg_yellow_dist} miles")
#         print(f"Average trip distance (green Jan 2024): {avg_green_dist} miles")
#         logger.info(f"Average trip distance (yellow Jan 2024): {avg_yellow_dist} miles")
#         logger.info(f"Average trip distance (green Jan 2024): {avg_green_dist} miles")
...
#         print(f"vehicle_emissions rows: {cnt_emissions}, avg CO2 g/mi: {avg_emission}")
#         logger.info(f"vehicle_emissions rows: {cnt_emissions}, avg CO2 g/mi: {avg_emission}")
